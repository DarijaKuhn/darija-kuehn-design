...
function Impressum() {
  ...
  const sections = (i18n.getResource(lang, "translation", "impressum.sections") || []) as Section[];
  const germanSections = (i18n.getResource("de", "translation", "impressum.sections") || []) as Section[];
