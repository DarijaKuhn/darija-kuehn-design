...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "author", content: "FECG Dresden e.V." },
      ...
      { property: "og:url", content: "https://freieevangeliums-dresden.de/" },
      { property: "og:image", content: "https://freieevangeliums-dresden.de/uploads/assets/Removal-518_86e18fc0.png" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "FECG Dresden — Русскоязычная евангельская церковь" },
      { name: "twitter:description", content: "Богослужения каждое воскресенье в 10:00. Altenberger Str. 87, 01279 Dresden." },
      { name: "twitter:image", content: "https://freieevangeliums-dresden.de/uploads/assets/Removal-518_86e18fc0.png" },
    ],
    links: [
      ...
      { rel: "alternate", hrefLang: "x-default", href: "https://freieevangeliums-dresden.de/" },
    ],
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          "@type": "Church",
          "name": "Freie Evangeliums-Christen-Gemeinde Dresden e.V.",
          "alternateName": ["FECG Dresden", "Русскоязычная евангельская церковь Дрезден"],
          "url": "https://freieevangeliums-dresden.de/",
          "logo": "https://freieevangeliums-dresden.de/uploads/assets/Removal-518_86e18fc0.png",
          "image": "https://freieevangeliums-dresden.de/uploads/assets/Removal-518_86e18fc0.png",
          "description": "Freie Evangeliums-Christen-Gemeinde Dresden e.V. — русскоязычная евангельская церковь (христиане-баптисты). Воскресные богослужения в 10:00.",
          "telephone": "+49 159 05316414",
          "email": "kontakt@freieevangeliums-dresden.de",
          "address": {
            "@type": "PostalAddress",
            "streetAddress": "Altenberger Strasse 87",
          ...
          "openingHoursSpecification": [
            ...
            { "@type": "OpeningHoursSpecification", "dayOfWeek": "Friday", "opens": "18:00", "closes": "19:30" }
          ],
          "sameAs": []
        }),
      },
