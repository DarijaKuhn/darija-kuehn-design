...
export const Route = createFileRoute("/contact")({
  ...
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Kontakt zur FECG Dresden: kontakt@freieevangeliums-dresden.de, +49 159 05316414, Altenberger Str. 87, 01279 Dresden." },
    ],
  }),
});
          ...
          <div className="form-grid">
            <div>
              ...
              <div className="form-ways">
                <a className="form-way" href="mailto:kontakt@freieevangeliums-dresden.de">
                  ...
                  <div><div className="form-way-label">{t("pages.contact.email")}</div><div className="form-way-val">kontakt@freieevangeliums-dresden.de</div></div>
                </a>
                <a className="form-way" href="tel:+4915905316414">
                  ...
                  <div><div className="form-way-label">{t("pages.contact.phone")}</div><div className="form-way-val">+49 159 05316414</div></div>
                </a>
