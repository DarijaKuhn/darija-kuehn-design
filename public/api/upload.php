...
if ($_SERVER['REQUEST_METHOD'] === 'POST'
  ...
  fail('Файл слишком большой для обычной загрузки. Большие проповеди теперь загружаются частями — обновите страницу админки после деплоя и попробуйте снова.', 413);
}
